...
$string['error:dirnotconfig'] = 'The [save to] and [restore from] directories have not been configured';
$string['error:storagenotconfig'] = 'A storage class has not been configured';
$string['error:selectedstoragenotconfig'] = 'The selected storage class has not been configured in {$a}';
