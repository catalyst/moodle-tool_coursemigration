...
$string['directory'] = 'Shared directory';
$string['directory:error'] = 'Shared directory must be readable and writable.';
$string['directory_help'] = 'Full path to the directory where you want to store the backup files';
...
$string['error:invalidbooleanvalue'] = 'Value for {$a->csvcolumn} must be empty, 0, or 1 on row {$a->rownumber}';
...
$string['error:selectedstoragenotreadyforpull'] = 'The selected backup storage has not been configured to pull backups';
$string['error:selectedstoragenotreadyforpush'] = 'The selected backup storage has not been configured to push backups.';
...
$string['settings:awss3_bucket_acl'] = 'Bucket ACL';
$string['settings:awss3_bucket_acldesc'] = 'Access control list (ACL) permissions for objects uploaded to S3. Default is "private".';
$string['settings:awss3_bucketdesc'] = 'The name of the bucket to store the logs in.';
$string['settings:awss3_connectionpullfailure'] = 'Failed to connect to S3 bucket for restore operations.';
$string['settings:awss3_connectionpullsuccess'] = 'Successfully connected to S3 bucket for restore operations.';
$string['settings:awss3_connectionpushfailure'] = 'Failed to connect to S3 bucket for backup operations.';
$string['settings:awss3_connectionpushsuccess'] = 'Successfully connected to S3 bucket for backup operations.';
$string['settings:awss3_key_prefix'] = 'Key prefix';
$string['settings:awss3_key_prefixdesc'] = 'Optional prefix for all object keys in the S3 bucket. Can be used to organize files or share buckets.';
$string['settings:awss3_keyid'] = 'Key ID';
$string['settings:awss3_keyiddesc'] = 'The AWS API key used to make AWS API calls for S3';
$string['settings:awss3_notconfigured'] = 'AWS S3 storage is not fully configured. Please provide all required settings.';
$string['settings:awss3_s3region'] = 'AWS Region';
$string['settings:awss3_s3regiondesc'] = 'The AWS Region to use for API calls';
$string['settings:awss3_secretkey'] = 'Secret Key';
$string['settings:awss3_secretkeydesc'] = 'The AWS secret key used to make AWS API calls for S3';
$string['settings:awss3_usesdkcreds'] = 'Use the default credential provider chain to find AWS credentials';
$string['settings:awss3_usesdkcredsdesc'] = 'If Moodle is hosted inside AWS, the default credential chain can be used for access to s3 logs.';
...
$string['settings:restoremaxretires'] = 'A number of retries';
$string['settings:restoremaxretiresdesc'] = 'A number of retries before claiming that a restore task is failed. If set to 0, no retry attempts will be done.';
$string['settings:shareddisk'] = 'Shared Disk Settings';
$string['settings:shareddisk_notconfigured'] = 'Shared disk directory is not configured.';
$string['settings:shareddisk_notexist'] = 'The configured directory does not exist.';
$string['settings:shareddisk_readablefailure'] = 'Directory is not readable for restore operations.';
$string['settings:shareddisk_readablesuccess'] = 'Directory is readable for restore operations.';
$string['settings:shareddisk_writablefailure'] = 'Directory is not writable for backup operations.';
$string['settings:shareddisk_writablesuccess'] = 'Directory is writable for backup operations.';
...
$string['storage:s3_storage'] = 'Amazon S3 storage';
